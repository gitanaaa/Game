...
class Box:
    ...
    def rule_text(self):
        ...
        self.rule_text1 = canvas.create_text(TITLE_BACK_X + 25, MESSAGE_Y - 10,
                                     text="・方向キーの右と左を使ってドリンクをゲットしよう！",
                                     anchor = "nw",
                                     font=('Malgun Gothic',14),
                                     fill = "red")
        self.rule_img_drink = canvas.create_image(TITLE_BACK_X + 25, MESSAGE_Y + 20,
                                     image = drink_img,
                                     anchor = ANCHOR)
        self.rule_text2 = canvas.create_text(TITLE_BACK_X + 25 +100, MESSAGE_Y + 40,
                                     text="：+50ポイント獲得",
                                     anchor = "nw",
                                     font=('Malgun Gothic',14))
        self.rule_img_rock = canvas.create_image(TITLE_BACK_X + 25, MESSAGE_Y + 90,
                                     image = iwa_img,
                                     anchor = ANCHOR)
        self.rule_text3 = canvas.create_text(TITLE_BACK_X + 25 + 100, MESSAGE_Y + 120,
                                     text="：当たったら即ご臨終",
                                     anchor = "nw",
                                     font=('Malgun Gothic',14))
        
        self.rule_img_trolley = canvas.create_image(TITLE_BACK_X + 25, MESSAGE_Y + 185,
                                     image = trolley_img,
                                     anchor = ANCHOR)
        self.rule_text4 = canvas.create_text(TITLE_BACK_X + 25 + 100, MESSAGE_Y + 180,
                                     text="：出生地不詳、1912年生まれの32歳",
                                     anchor = "nw",
                                     font=('Malgun Gothic',10))
        self.rule_text5 = canvas.create_text(TITLE_BACK_X + 25 + 100, MESSAGE_Y + 200,
                                     text="　やや薄くなり始めた煤だらけの長髪を後ろで雑にまとめ、",
                                     anchor = "nw",
                                     font=('Malgun Gothic',10))
        self.rule_text6 = canvas.create_text(TITLE_BACK_X + 25 + 100, MESSAGE_Y + 220,
                                     text="　顔は青白く、頬はやせこけ、落ちくぼんだ眼窩からは",
                                     anchor = "nw",
                                     font=('Malgun Gothic',10))
        self.rule_text7 = canvas.create_text(TITLE_BACK_X + 25 + 100, MESSAGE_Y + 240,
                                     text="　生気は感じられない。",
                                     anchor = "nw",
                                     font=('Malgun Gothic',10))
        self.rule_text8 = canvas.create_text(TITLE_BACK_X + 25 + 100, MESSAGE_Y + 260,
